...
//=========================INPUT - CAM BIEN - NUT NHAN ==================================//
#define CB_CHAM_THANH GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_2)
#define CB_QUANG_TRAI GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_14)
#define CB_QUANG_PHAI GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_15)
#define NUT_1 GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_3)
...
int laze_nhan_banh_value, lazeSauValue, lazeTraiValue, lazePhaiValue, BienTroTrucXValue, BienTroTrucYValue = 0, BienTroMamXoayValue = 0, i = 0;
...
int dang_Ban = 0;
int TAM_X, SILO_THA_BONG, TAM_Y, Tam_SILO;

int TocDoToiDaCoKhi = 60;

/* Mam_Xoay */
int Mam_Xoay_Min = 145;
int Mam_Xoay_Max = 955;
int Mam_Xoay_Gap_Bong = 765;								//765;
int Mam_Xoay_Bo_Bong = 230;
int Mam_Xoay_Target = 765;
int Mam_Xoay_Bat_Dau = 400;
...
void HMI_TRAN(vs32 _so_dong)
{
	...
	case 1:
		...
		break;
	case 2:
		HMI_DMI("LAZER_BAT_BONG:", laze_nhan_banh_value, 2);
		break;
	case 3:
	...
	case 9:
		...
		//HMI_DMI("Servo_Bong:", Servo_Bong, 9);
		break;
		//										if(NUT_CHUYEN_SAN == 1){
